...
extern (C) void __gmpf_add_ui (mpf_ptr, mpf_srcptr, ulong);
...
extern (C) int __gmpf_cmp_si (mpf_srcptr, long) nothrow pure;

alias mpf_cmp_ui = __gmpf_cmp_ui;
extern (C) int __gmpf_cmp_ui (mpf_srcptr, ulong) nothrow pure;
...
extern (C) void __gmpf_div_ui (mpf_ptr, mpf_srcptr, ulong);
...
extern (C) int __gmpf_fits_ulong_p (mpf_srcptr) nothrow pure;
...
extern (C) double __gmpf_get_d_2exp (long *, mpf_srcptr);
...
extern (C) long __gmpf_get_si (mpf_srcptr) nothrow pure;
...
extern (C) ulong __gmpf_get_ui (mpf_srcptr) nothrow pure;
...
extern (C) void __gmpf_init_set_si (mpf_ptr, long);
...
extern (C) void __gmpf_init_set_ui (mpf_ptr, ulong);
...
extern (C) void __gmpf_mul_ui (mpf_ptr, mpf_srcptr, ulong);
...
extern (C) void __gmpf_pow_ui (mpf_ptr, mpf_srcptr, ulong);
...
extern (C) void __gmpf_ui_div (mpf_ptr, ulong, mpf_srcptr);

alias mpf_ui_sub = __gmpf_ui_sub;
extern (C) void __gmpf_ui_sub (mpf_ptr, ulong, mpf_srcptr);
